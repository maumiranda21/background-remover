...
if remove is None:
    st.error(
        ...
        "En entornos como Streamlit Cloud, añade `requirements.txt` a tu repo y vuelve a desplegar.\n\n"
...
if process_btn and uploaded:
    ...
    n = len(uploaded)
    # Ajuste: número máximo de hilos igual a min(4, n) — evita sobrecargar entornos compartidos
